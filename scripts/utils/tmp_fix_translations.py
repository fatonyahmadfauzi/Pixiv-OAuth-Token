...
# Process app.js
fix_app_js("web/src_backup/public__assets__app.js")
fix_app_js("web/public/assets/app.js")

# Process HTML/footer files
fix_html_js("web/src_backup/public__components__footer.js")
fix_html_js("web/src_backup/public__tutorial.html")
fix_html_js("web/public/components/footer.js")
fix_html_js("web/public/tutorial.html")
