...
- Aplicación web (`web/public/` + sin servidor API)
...
La versión/identidad de compilación de la aplicación se almacena en `version.json`.
...
> [!IMPORTANTE]
> Si realiza cambios en HTML, CSS o JS, recuerde ejecutar `cd web && node build_minify.js` antes de implementar para ofuscar automáticamente el código y comprimir los activos.
