...
export const DISPLAY_LANGUAGES = {
    en: {
      ...
      supportScanInstruction:
        "Scan with your supported e-wallet or banking app.",
    ...
    pl: {
      ...
      discussShowShare:
        "Podziel się tym, co zbudowałeś za pomocą tego narzędzia",
    ...
    zh: {
      ...
      cliPreviewDesc:
        "通过 CLI 输出模拟，快速查看登录流程、代码解析和令牌结果。",
      ...
      tutorialStep6Desc:
        "点击交换令牌，然后复制 access_token / refresh_token。",
      errApiNotFound:
        "未找到 API 端点（404）。请先将 /api/token 部署到 Vercel。",
    ...
    de: {
      ...
      needVisualGuide:
        "Brauchst du eine visuelle Schritt-für-Schritt-Anleitung?",
      ...
      footerBrandText: "Pixiv OAuth",
      footerCopyright:
        "© 2025 Pixiv OAuth Web · Erstellt von Fatony Ahmad Fauzi",
    ...
    pt: {
      ...
      downloadsTitle: "Downloads",
      downloadsDesc:
        "Baixe a build mais recente diretamente do GitHub Releases.",
      quickCmdTitle: "Comando rápido",
      quickCmdDesc:
      ...
      tutorialStep1Desc:
        "Abra a página de login do Pixiv pelo console web tool.",
      ...
      dlTabCmd: "CMD",
      dlDescWin1:
        "Baixe um executável independente. Não sabe sua arquitetura? ",
    ...
    id: {
      ...
      tutorialStep5Desc:
        "Tempel URL callback atau kode ke input OAuth console.",
      ...
      footerBrandText: "Pixiv OAuth",
      footerCopyright:
        "© 2025 Pixiv OAuth Web · Dibuat oleh Fatony Ahmad Fauzi",
    ...
    kr: {
      ...
      quickCmdTitle: "빠른 명령",
      quickCmdDesc:
        "PowerShell/CMD 다운로드 명령과 pip 설치 명령을 복사하세요.",
      ...
      contactUsTitle: "연락처",
      contactUsDesc:
        "질문, 제안 또는 도움이 필요하신가요? 메시지를 보내주세요.",
...
export const FLAG_CLASS = {
  en: "fi-gb", pl: "fi-pl", zh: "fi-cn", jp: "fi-jp", de: "fi-de",
  fr: "fi-fr", es: "fi-es", ru: "fi-ru", pt: "fi-pt", id: "fi-id", kr: "fi-kr"
};

export const LANG_NAME = {
  en: "English", pl: "Polski", zh: "\u4e2d\u6587", jp: "\u65e5\u672c\u8a9e", de: "Deutsch",
  fr: "Fran\u00e7ais", es: "Espa\u00f1ol", ru: "\u0420\u0443\u0441\u0441\u043a\u0438\u0439", pt: "Portugu\u00eas", id: "Indonesia", kr: "\ud55c\uad6d\uc5b4"
};
